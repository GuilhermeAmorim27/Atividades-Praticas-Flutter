...
class QuartaTela extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Corpo corpo = Corpo('4');
    Botoes_3 botoes_3 = Botoes_3('', 'segunda');
    return Tela('Quarta Tela', corpo, botoes_3);
  }
}
...
class Botoes_3 extends StatelessWidget {
  final String proxima;
  final String segundaPagina;
  Botoes_3(this.proxima,this.segundaPagina);
  @override
  Widget build(BuildContext context) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        ...
        ElevatedButton(
          child: Text("2"),
          onPressed: () {
            Navigator.pushNamed(context, '/${this.segundaPagina}');
          },
        ),
