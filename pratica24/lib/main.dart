...
class PrimeiraRotaState extends State<PrimeiraRota> {
  ...
  void atualizarProduto(int indice, Produto produto) {
    setState(() => this.produtos[indice] = produto);
  }
...
class QuartaRota extends StatefulWidget {
  QuartaRotaState createState() {
    return QuartaRotaState();
  }
}

class QuartaRotaState extends State<QuartaRota> {
  ItemMenu? itemSelecionado;
  List<DropdownMenuItem<ItemMenu>>? listaItensMenu;
  final TextEditingController nomeController = TextEditingController();
  final TextEditingController descricaoController = TextEditingController();
