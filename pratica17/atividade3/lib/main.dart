...
//List<Map> imagens =[]
  ...
  List<Map> imagens = [
    {
      'arquivo': 'img/bigbangtower.jpg',
      'titulo': 'Big Bang Tower',
      'descricao': 'Big Bang Tower,  London/England'
    },
    {
      'arquivo': 'img/eiffeltower.jpg',
      'titulo': 'Eiffel Tower',
      'descricao': 'Eifeel Tower,  Paris/France'
    },
    {
      'arquivo': 'img/leaningtowerofpisa.jpg',
      'titulo': 'Tower of Pisa',
      'descricao': 'Leaning Tower of Pisa,  Pisa/Italy'
    },
    {
      'arquivo': 'img/shanghaitower.jpg',
      'titulo': 'Shanghai Tower',
      'descricao': 'Shanghai Tower,  Shanghai/China'
    }
  ];
      ...
      onTap: () {
        Navigator.pushNamed(
          ...
          arguments: ArgumentosDaRota(
            imagens[indice]['titulo'],
            imagens[indice]['descricao'],
          ),
        );
      });
  Row cursor() => Row(
